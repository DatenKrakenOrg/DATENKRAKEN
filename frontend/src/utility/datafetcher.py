...
class IDataFetcher:
    def get_unique_arduino_ids() -> Dict[SensorType, List[str]]:
    ...
    def get_newest_bucket(arduino_id: str) -> Tuple[Temperature, Humidty, Voc, Noise]:
    ...
    def get_bucket_by_t_interval(sensor_type: SensorType, arduino_id: str, start_date: DateTime, end_date: DateTime) -> pd.DataFrame:
